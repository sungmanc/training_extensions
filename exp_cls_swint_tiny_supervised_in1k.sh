...
do
    ...
    --load-weights=/home/sungmanc/scripts/pretrained_weights/supervised_swin_tiny_1k.pth \
    --save-model-to=./outputs/large_upm_cls_benchmark/full_data_finetune/cls_per_img_6/supervised_swin_tiny_1k_lr${lr}_${data}_${trial}/results
done
