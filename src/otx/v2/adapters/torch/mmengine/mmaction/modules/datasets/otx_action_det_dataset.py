...
import mmengine
import numpy as np
from mmaction.evaluation.functional.ava_utils import det2csv
from mmaction.datasets.ava_dataset import AVADataset
from mmaction.registry import DATASETS
from mmengine.dataset import Compose
from otx.v2.api.utils.logger import get_logger

from otx.v2.adapters.torch.mmengine.mmaction.modules.datasets.pipelines.loading import OTXRawFrameDecode
from otx.v2.adapters.torch.mmengine.mmaction.utils import det_eval
    ...
    class _DataInfoProxy:
        def __init__(
            ...
            if os.path.exists(self.proposal_file):
                self.proposals = mmengine.load(self.proposal_file)
